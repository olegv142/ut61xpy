...
Stat = namedtuple('Stat', ('aver', 'std_dev', 'cm3'))
...
class StatCollector:
    ...
    def print(self):
        ...
        if self.total_valid:
            ...
            if st.std_dev:
                print('skewness  [%%]  : %.2f' % (100 * st.cm3 / (st.std_dev ** 3)))
...
if __name__ == '__main__':
    ...
    print(st)
    max_err = 1e-14
    m2, m3 = stats.moment(vals, 2), stats.moment(vals, 3)
